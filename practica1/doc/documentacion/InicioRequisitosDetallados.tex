\subsection{Especificación detallada de requisitos} \label{requisitos-detallados}
...
diferente del nuevo centro de salud seleccionado. Otra situación en la que
se deberá cambiar forzosamente el médico asignado a un beneficiario será cuando
el médico asociado al beneficiario se elimine del sistema. El NIF y el NSS de
un beneficiario es fijo y no se puede modificar en ningún caso.
...
médico, todas las citas pendientes que tuviera que queden fuera del nuevo
horario se deberán anular automáticamente, avisando a los beneficiarios
correspondientes. En general, debido a su relevancia, todas las operaciones
relacionadas con la gestión de usuarios sólo las pueden realizar los usuarios
...
administrador. Además, los médicos también podrán utilizar el sistema para
consultar cuándo tienen las siguientes citas asignadas, pero no se les
permitirá tramitar o anular citas.
