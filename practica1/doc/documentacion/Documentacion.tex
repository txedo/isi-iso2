...
% -------------------------------------------------------------------------------------------------------------
\def\diagrama#1#2#3{\textbf{Fichero de Visual Paradigm correspondiente al}
 ...
 \ifthenelse{\equal{#2}{análisis}}{\textbf{clases de #2}}
 {\ifthenelse{\equal{#2}{casosUso}}{\textbf{casos de uso}}}
 {\ifthenelse{\equal{#2}{estados}}{\textbf{máquina de #2}}{\textbf{#2}}} \textbf{-\textgreater {} \textit{#3}}
}
