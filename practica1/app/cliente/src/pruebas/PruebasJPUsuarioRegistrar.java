...
public class PruebasJPUsuarioRegistrar extends org.uispec4j.UISpecTestCase implements IDatosConexionPruebas {
	...
	protected void tearDown() {
		...
		try {
			// Si se ha creado algún usuario, lo eliminamos
			if (usuarioCreado) {
				u = controlador.consultarUsuario(nif);
				// Comprobamos si se trataba de un médico
				if (u instanceof Medico) {
					m = controlador.consultarMedico(nif);
	...
	public void testRegistrarAdministradorValido1() {
		String login = "";
		Random r = new Random();
		...
		try {
			...
			// y comprobamos que los campos no se han borrado
			txtNIF.setText(UtilidadesPruebas.generarNIF());
			txtNombre.setText("Pedro");
			txtApellidos.setText("Jiménez Serrano");
			txtLogin.setText(login);
			txtPassword.setPassword("administrador");
	...
	public void testRegistrarAdministradorValido2() {
		String login = "";
		Random r = new Random();
	...
	@SuppressWarnings("deprecation")
	public void testRegistrarCitadorValido1() {
		String login = "";
		Random r = new Random();
	...
	public void testRegistrarCitadorValido2() {
		String login = "";
		Random r = new Random();
	...
	@SuppressWarnings("deprecation")
	public void testRegistrarMedicoValido1() {
		String login = "";
		Random r = new Random();
	...
	public void testRegistrarMedicoValido2() {
		String login = "";
		Random r = new Random();
	...
	public void testRegistrarMedicoValido3() {
		String login = "";
		Random r = new Random();
