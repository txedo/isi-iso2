...
*/
/**
 * Ventana 'Acerca de' del servidor de respaldo.
 */
public class JFAcercaDeRespaldo extends javax.swing.JFrame {
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Acerca del Servidor de Respaldo (SSCA)");
			{
				jPanel1 = new JPanel();
				...
				jPanel1.setLayout(jPanel1Layout);
				{
					...
					lblTitulo2.setText("Servidor de Respaldo");
