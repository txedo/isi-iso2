...
\usepackage{rotating} % para rotar elementos
\hypersetup{bookmarksopen,bookmarksopenlevel=4,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={Aplicaciones para móviles con SS.OO Symbian},
						pdfauthor={Juan Andrada Romero, Juan Gallardo Casero, José Domingo López López},
...
{\end{list}}
% Macro para definir una lista personalizada con un icono diferente
\newenvironment{milista2}%
{\begin{list}{\tiny{\ding{'156}}}%
{\settowidth{\labelwidth}{\textbullet} \setlength{\leftmargin}{\dimexpr\labelsep+\labelwidth+5pt}
\setlength{\itemsep}{\dimexpr 0.5ex plus 0.25ex minus 0.25ex}
\setlength{\parsep}{\itemsep}
\setlength{\partopsep}{\itemsep}
...
\clearpage
\input{2requisitos.tex}
\clearpage
\input{3caracteristicas.tex}
\clearpage
\input{4marcas.tex}
\clearpage
\input{5versiones.tex}
\clearpage
\input{6desarrollo.tex}
\clearpage
\input{7ejemplo.tex}
\clearpage
\input{8comparativa.tex}
\clearpage
