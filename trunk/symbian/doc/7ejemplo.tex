...
La aplicación ha sido desarrollada en Symbian C++ utilizando el SDK de las series S60 3rd Edition, porque se disponía de un móvil compatible con esta plataforma para probar el software. De hecho, la serie S60 3rd Edition es la que tiene mayor compatibilidad con los teléfonos Symbian que hay actualmente en el mercado, ya que los programas desarrollados para esa serie también funcionan en todos los móviles de las series posteriores.
...
En la Figura \ref{fig:ejemplos} se observan varias pantallas del emulador que incorpora el S60 3rd Edition SDK de Symbian con la aplicación de ejemplo en ejecución. En ellas se pueden ver las dos cámaras disponibles y el menú de opciones.
...
Finalmente, conviene resaltar que, además de haber probado este programa en el emulador del SDK, también se ha instalado y ejecutado con éxito en un teléfono móvil real Nokia 6210 Navigator, aunque para ello fue necesario utilizar una versión anterior del SDK por problemas durante la compilación.
