...
ver claramente las seis iteraciones en las que se pretendía dividir el
desarrollo, tras las cuales se planificó una reunión con el cliente o la
...
Con respecto a la planificación y estimación del tiempo necesario para realizar
el proyecto, en el plan inicial de desarrollo se indicó que el sistema final se
iba a entregar el día 15 de Febrero de 2010, mientras que en la realidad se ha
tenido que entregar el día 15 de Marzo de 2010, justo un mes después.

Esta diferencia de tiempo se debe a varios riesgos que se han dado en el
proyecto y que se citan a continuación:
\begin{milista}
\item \textbf{Dificultades al realizar la estimación}. Debido a la falta de
experiencia en el desarrollo de sistemas grandes, tuvimos bastantes dudas a la
hora de determinar cuál sería el esfuerzo y el tiempo estimado en realizar cada
una de las partes del proyecto. A algunas partes del sistema que resultaron ser
sencillas (como el desarrollo del servidor de respaldo) se les asignó el mismo
tiempo de análisis, diseño, implementación y pruebas que a otras mucho más
complejas (como el desarrollo de un grupo de casos de uso).
\item \textbf{Aparición de nuevos requisitos}. El plan de desarrollo inicial se
hizo antes de comenzar el estudio detallado de todos los requisitos que debían
satisfacer los sistemas. Por este motivo, unos meses después de realizar el
plan se comenzaron a plantear nuevos requisitos que provocaron que el plan
estuviera cada vez más desajustado con la realidad.
\item \textbf{Complejidad del cliente}. En un principio, se estimó que no se
tardaría más de dos semanas en desarrollar la parte del sistema que no tendría
la funcionalidad principal (en el plan inicial esta parte fue el servidor
front-end, al final ha sido la unidad de citación). Sin embargo, el desarrollo
de la unidad de citación ha requerido realmente mucho más trabajo de
implementación (no así de análisis y diseño) que el servidor front-end, por lo
que la planificación temporal no ha reflejado la realidad del diseño.
\end{milista}

A pesar de estos riesgos, se ha conseguido entregar el proyecto sólo un mes
después de su fecha planificada de entrega, para lo cual ha sido necesario que
todos los miembros del grupo de trabajo dedicaran un gran número de horas 
semanales (bastantes más de las estimadas inicialmente) al diseño,
implementación y documentación del sistema durante el último mes y medio de
desarrollo.
